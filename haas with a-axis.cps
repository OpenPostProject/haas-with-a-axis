...
description = "HAAS - A-axis (pre-NGC)";
...
longDescription = "Generic post for 4-axis HAAS mill. This post is for the pre-Next Generation Control. By default positioning moves will be output as high feed G1s instead of G0s. You can turn on the property 'useG0' to force G0s but be careful as the CNC will follow a dogleg path rather than a direct path.";
deprecatedDescription = "This post has been deprecated. Use the generic HAAS (Pre-NGC) post instead.";
...
properties = {
  ...
  makeAAxisOtherWay: {
    title      : "Rotate A-axis the opposite direction",
    description: "Use the left hand rule for the A-axis output.",
    type       : "boolean",
    value      : false,
    scope      : "post"
  },
  ...
  singleResultsFile: {
    ...
    description: "Set to false if you want to store the measurement results for each probe / inspection toolpath in a seperate file",
    group      : 0,
    type       : "boolean",
    value      : true,
    scope      : "post"
